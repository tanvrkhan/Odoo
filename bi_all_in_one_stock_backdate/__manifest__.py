...
{
	'name':"All in one Backdate - All in one Stock Backdate and Remarks",
	'version':'16.2.0.1',
	'category':'Warehouse',
	'summary':'All Inventory backdate all stock transfer backdate stock backdate inventory adjustment backdate stock operation backdate all stock back-date backdate mrp backdate sale backdate purchase backdate manufacturing backdate all backdate picking backdate invoice',
	'description':"""
    ...
    "auto_install": False,
    "installable": True,
    "live_test_url":'https://youtu.be/XaHE8hg5vPI',
